...
export interface StatisticsProps {
    ...
    createdMarkets: { [key in SupportedAsset]: number };
    totalVotes: {
        up: number;
        down: number;
    };
...
export default function Statistics(props: StatisticsProps) {
    const { createdMarkets, placedBetsAmount, totalBettingAmount, totalVotes } = props;

    return (
        <div className="grid grid-cols-2 gap-4 text-white">
            <Web3AmountCard className="col-span-2" title='Created Markets' assetCounts={createdMarkets} />
            ...
            <Card className="p-4 flex flex-col">
                ...
                <span className="text-lg font-semibold">{totalBettingAmount / 10 ** 8} APT</span>
            </Card>
            <Card className="p-4 flex flex-col">
